...
---
##  Ομάδα:
- Γρίβας Αθανάσιος (Συλλογή δεδομένων)
- Γκούσκου Σοφία (Ανάλυση γραφημάτων στην παρουσίαση)
- Σωτηρίου Έλλη (Οργάνωση παρουσίασης)
- Χουλιάρας Βασίλειος (Δημιουργία κώδικα & γραφημάτων)
