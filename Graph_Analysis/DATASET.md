...
Καταγραφή για μία εβδομάδα. Υπάρχουν μεγάλα διαστήματα με 0 W (το κλιματιστικό εκτός λειτουργίας) και στιγμές όπου η ισχύς κινείται κυρίως γύρω στα ~500–1100 W. Σε ορισμένες εκκινήσεις εμφανίζονται και αιχμές 2000–2200 W.
