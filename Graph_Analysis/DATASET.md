...
Κινείται μεταξύ 16.5°C και 18°C, με μερικές σύντομες κορυφές πάνω από 20°C. Αυτές οι κορυφές υποδεικνύουν τις αλλαγές στην θέρμανση, επειδή η τιμή ανέβαινει απότομα και μετά πέφτει ξανά σχετικά γρήγορα που οφείλεται  στον αφυγραντήρα.
Οι αιχμές αυτές βρίσκονται στις 18,19,20 και 22 Μαρτίου. Μετά την μεγάλη κορυφή στις 23 Μαρτίου, η θερμοκρασία επιστρέφει σταθερά γύρω στους 17.5°C με 18°C.
