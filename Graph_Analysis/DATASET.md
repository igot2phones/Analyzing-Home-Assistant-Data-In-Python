...
### Μέση Ωριαία Κατανάλωση Ισχύος και Υγρασία

Καταγραφή για μία εβδομάδα. Η κατανάλωση παρουσιάζει εναλλαγές μεταξύ πολύ χαμηλών τιμών (κατάσταση αναμονής ή απενεργοποίησης) και σταθερών μεσαίων επιπέδων, που αντιστοιχούν σε κανονική λειτουργία αφύγρανσης. Παρατηρούνται επίσης στιγμιαίες αυξήσεις ισχύος, οι οποίες σχετίζονται κυρίως με εκκινήσεις του συμπιεστή.

- Η μέγιστη τιμή της κατανάλωσης κατά την 7-ήμερη περίοδο ανέρχεται περίπου σε **220 W**, και αντιστοιχεί σε φάσεις έντονης λειτουργίας της συσκευής όταν η υγρασία είναι αυξημένη.

- Η ελάχιστη τιμή της κατανάλωσης είναι **0.00 W**, που υποδηλώνει πλήρη παύση λειτουργίας.

- Η μέση τιμή της κατανάλωσης στο διάστημα των 7 ημερών ανέρχεται σε **92.03 W**, γεγονός που δείχνει ότι η συσκευή λειτουργεί διακεκομμένα και όχι συνεχώς.
...
### Μέση Ωριαία Κατανάλωση Ισχύος και Θερμοκρασία

Καταγραφή για μία εβδομάδα. Η κατανάλωση χαρακτηρίζεται από μεγάλα διαστήματα μηδενικής λειτουργίας και σύντομες περιόδους υψηλής ισχύος. Η λειτουργία είναι έντονα διακοπτόμενη, με εμφανείς αιχμές κατά την εκκίνηση και τη ρύθμιση της θερμοκρασίας.

- Η μέγιστη τιμή της κατανάλωσης κατά την 7-ήμερη περίοδο ανέρχεται περίπου σε **1430 W**, και αντιστοιχεί σε στιγμές έντονης λειτουργίας (πιθανώς εκκίνηση ή υψηλό φορτίο).

- Η ελάχιστη τιμή της κατανάλωσης είναι **0.00 W**, που αντιστοιχεί σε πλήρη απενεργοποίηση της συσκευής.

- Η μέση τιμή της κατανάλωσης στο διάστημα των 7 ημερών ανέρχεται σε **366.71 W**, υποδεικνύοντας ότι το κλιματιστικό λειτουργεί σποραδικά αλλά με υψηλή ισχύ όταν ενεργοποιείται.
