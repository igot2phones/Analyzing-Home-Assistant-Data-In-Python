...
### Ψάχνουμε απο συσκευές

- Κατανάλωσης συσκευών (σε Kwh) ειτε ανα ωρα ειτε ανα μερα ειτε ανα μηνα (θα το δουμε).
- Στις συσκευες να βρουμε την κατανάλωση τους tdp (μεγιστη, ελαχιστη, μεση).

### Δεδομενα απο το περιβάλλον 

- **Καιρος** (Πως επηρεαζει τη χρηση συσκευων & προβλεψη) 
- **Αισθητηρες** (Κινησης, Θερμοκρασιας, Υγρασιας κτλπ)
- **Κατασκευη σπιτιου** (Μονωσεις κτλπ)
...
- **Collection (Συλλογή)** → Καταγραφή μετρήσεων ισχύος (W) και/ή κατανάλωσης (kWh) με χρονικές σφραγίδες.
...
- **Modelling / Display / Interpretation (Μοντελοποίηση/Απεικόνιση/Ερμηνεία)** → Γραφήματα, συγκρίσεις, ποσοστά και εντοπισμός μοτίβων χρήσης.
- **Dissemination (Διάδοση)** → Τελική αναφορά (π.χ. PDF) με αποτελέσματα και συμπεράσματα.
