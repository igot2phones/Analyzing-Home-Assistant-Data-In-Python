...
- Κατανάλωση απο αισθητήρες (σε Kwh/ημέρα)
- Στις συσκευες να βρουμε την ενδεικτική κατανάλωση τους  (μέγιστη, ελάχιστη, μέση).

### Από το περιβάλλον 

- **Καιρός** (Πως επηρεάζει τη χρήση σύσκευων & πρόβλεψη) 
- **Αισθητήρες** (Κινησης, Θερμοκρασίας, Υγρασίας κτλπ)
- **Κατασκευή οικίας** (Μονώσεις είδος θέρμανσης κτλπ).
